      ...
      <div className="pb-5">
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5'> 
          ...
          <input
            ...
            type="text" className='bg-transparent border-none outline-none text-white text-xs text:-[#c8c8c8] flex-1' placeholder='Search User...' />
        </div>
      ...
      <div className='flex flex-col'>
        {filteredUsers.map((user) => (
          <div onClick={() => {
            ...
            {(unseenMessages[user._id] || 0) > 0 && <p className='absolute top-4 right-4 text-xs h-5 w-5 flex justify-center items-center rounded-full bg-violet-500/50'>
