    ...
    >
      <div className="pb-5">
        <div className="flex justify-between items-center">
          {/* <img src={assets.logo} alt="logo" className="max-w-20 bg-amber-800" /> */}
          <img
            src={assets.logo}
            alt="logo"
          ...
          <div className="relative py-2 group my-1">
            <img
        ...
        <div className="bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-0">
          ...
          <input
            ...
            type="text"
            className="bg-transparent border-none outline-none text-white text-xs text:-[#c8c8c8] flex-1"
